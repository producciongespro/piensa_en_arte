<?php
	...
	session_start();
	if(!isset($_SESSION["id_usuario"])){ //Si no ha iniciado sesi杌妌 redirecciona a index.php
				...
				<div class='container-fluid'>
					...
					<div id='navbar' class='navbar-collapse collapse'>
    						...
    						<?php if($_SESSION['tipo_usuario']==3) { ?>
                            	...
                            	<ul class='nav navbar-nav'>
    		                        <li><a href='../videos.php'>Galería de Vídeos</a></li>
                            	</ul>
                            	<ul class='nav navbar-nav'>
    		                        <li><a href='../ver_registros.php'>Galería de audios</a></li>
                            	</ul>
                            	<ul class='nav navbar-nav'>
