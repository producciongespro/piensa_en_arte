...
$mysqli=conectarDB();
	...
	function registraUsuario($pass_hash, $nombre, $apellido1, $apellido2, $email, $activo, $token, $tipo_usuario){
		global $mysqli;
		$stmt = $mysqli->prepare("INSERT INTO usuarios (password, nombre, apellido1, apellido2, correo, activacion, token, id_tipo) VALUES(?,?,?,?,?,?,?,?)");
		$stmt->bind_param('sssssisi', $pass_hash, $nombre, $apellido1, $apellido2, $email, $activo, $token, $tipo_usuario);
	...
	function enviarEmail($email, $nombre, $asunto, $cuerpo){
		...
		require_once '../server/PHPMailer/PHPMailerAutoload.php';
